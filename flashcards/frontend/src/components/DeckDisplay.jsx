        ...
        <div className='deck-title-and-buttons'>
          <div className='title-left-buttons'>
            ...
            <div className='left-buttons'>
              <button className='deck-display-add-study-session-icon'><AddIcon fontSize='small'/> Add to study session</button>
              <button className='deck-display-quiz-icon'><QuizIcon fontSize='small'/>Quiz Mode</button>
            </div>
          </div>
          <div className='right-buttons'>
          <button className='deck-display-add-flashcard-icon'><AddIcon fontSize='small'/> Add Flashcard</button>
          <button className='deck-display-edit-icon'><EditIcon fontSize='small'/> Edit Deck</button>
          <button className='deck-display-delete-icon'><DeleteIcon fontSize='small'/>Delete Deck</button>
          </div>
        </div>
